...
<span class="red"><?php echo form_error('content');?></span><span class="muted" style="float:right">(可直接粘贴链接和图片地址/发代码用&lt;pre&gt;标签)</span>
</div>
</div>
<?php if($this->config->item('auto_tag') =='off'){?>
<div class="control-group">
  <label class="control-label" for="keywords">标签：</label>
  <div class="controls">
