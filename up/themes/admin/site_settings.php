...
<div class='controls'>
<input id="settings_site_name" name="site_name" type="text" value="<?php echo $item['0']['value'];?>" />
...
<div class='controls'>
<input class="span4" id="settings_welcome_tip" name="welcome_tip" type="text" value="<?php echo $item['1']['value'];?>" />
...
<div class='controls'>
<input class="span4" id="settings_short_intro" name="short_intro" type="text" value="<?php echo $item['2']['value'];?>" />
...
<div class='controls'>
<input class="span4" id="settings_marketing_str" name="site_keywords" type="text" value="<?php echo $item['6']['value'];?>" />
<small class='help-inline'>用英文逗号(,)隔开</small>
</div>
</div>
<div class='control-group'>
<label class="control-label" for="settings_static">网站风格</label>
<div class='controls'>
<input class="sls" id="settings_static" name="static" type="text" value="<?php echo $this->config->item('static');?>" />
<small class='help-inline'>例如: default,white</small>
</div>
</div>
<div class='control-group'>
<label class="control-label" for="settings_themes">模板目录设定</label>
<div class='controls'>
<input class="sls" id="settings_themes" name="themes" type="text" value="<?php echo $this->config->item('themes');?>" />
...
<div class='control-group'>
<label class="control-label" for="auto_tag">标签开关</label>
<div class='controls'>
<label class='radio inline'>
...
<div class='controls'>
<textarea class="span6" id="settings_custom_head_tags" name="site_stats" rows="5"><?php echo $item['5']['value'];?>
</textarea>
...
<div class='controls'>
<input id="settings_reward_title" name="reward_title" type="text" value="<?php echo $item['8']['value'];?>" />
...
<div class='control-group'>
<label class="control-label" for="is_approve">话题(回复)审核开关</label>
<div class='controls'>
<label class='radio inline'>
...
<input class="input-mini" id="settings_pagination_comments" name="per_page_num" type="text" value="<?php echo $item['9']['value'];?>" />
...
<div class='control-group'>
<label class="control-label" for="settings_timespan">发贴时间间隔</label>
<div class='controls'>
<div class='input-append'>
<input class="input-mini" id="settings_timespan" name="timespan" type="text" value="<?php echo $this->config->item('timespan');?>" />
...
<div class='control-group'>
<label class="control-label" for="settings_words_limit">发贴字数限制</label>
<div class='controls'>
<div class='input-append'>
<input class="input-mini" id="settings_words_limit" name="words_limit" type="text" value="<?php echo $this->config->item('words_limit');?>" />
<span class='add-on'>/ 字</span>
<small class='help-inline'>默认5000字</small>
</div>
</div>
</div>
...
<div class='controls'>
<input id="settings_site_name" name="qq_appid" type="text" value="<?php echo $this->config->item('qq_appid');?>" />
...
<div class='controls'>
<input class="span4" id="settings_qq_appkey" name="qq_appkey" type="text" value="<?php echo $this->config->item('qq_appkey');?>" />
...
<div class="control-group">
<label class="control-label" for="settings_default_controller">默认首页模块:</label>
<div class="controls">
<input id="settings_default_controller" name="default_controller" type="text" value="<?php echo $this->router->routes['default_controller'];?>" />
...
<div class="control-group">
<label class="control-label" for="settings_tag_url">tag内容页url:</label>
<div class="controls">
<input id="settings_tag_url" name="tag_url" type="text" value="<?php echo $routes[8];?>" />
