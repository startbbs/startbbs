...
<td class='center'>
<a href="<?php echo site_url('admin/users/edit/'.$v['uid']);?>" class="btn btn-small">修改</a>
<a href="<?php echo site_url('admin/users/del/'.$v['uid']);?>" class="btn btn-small btn-danger">删除</a>
</td>
</tr>
<?php }?>
</tbody>
...
<th align='left' class='w50'>用户组</th>
<th align='left' class='auto'>类型</th>
<th align='right' class='auto'>用户数</th>
<th>操作</th>
</tr>
</thead>
<tbody>
...
<td align='right'><?php echo $v['gid']?></td>
<td align='left' class='auto'>
<strong>
...
<td class='center'>
<a href="<?php echo site_url('admin/users/group/edit/'.$v['gid']);?>" class="btn btn-small">修改</a>
<?php if($v['group_type']>=2){?>
<a href="<?php echo site_url('admin/users/group/del/'.$v['gid']);?>" class="btn btn-small btn-danger">删除</a>
<?php }?>
</td>
</tr>
<?php }?>
...
<label class="string required control-label" for="user_group_name">用户组名</label>
<div class="controls">
<input class="string required" id="user_group_name" name="group_name" size="50" type="text" value="" /></div></div>

<div class='form-actions'>
<input class="btn btn-small btn-primary" name="commit_add" type="submit" value="添加用户组" />
</div>
</form>
</div>
<?php }?>
...
<label class="string required control-label" for="user_group_name">用户组名</label>
<div class="controls">
<input class="string required" id="user_group_name" name="group_name" size="50" type="text" value="<?php echo $group_info['group_name']?>" /></div></div>

<div class='form-actions'>
<input class="btn btn-small btn-primary" name="commit_edit" type="submit" value="更新用户组" />
</div>
</form>
</div>
<?php }?>
