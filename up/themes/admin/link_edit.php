...
<div class="controls">
<input class="string required" id="name" name="name" size="50" type="text" value="<?php echo $link['name']?>" /></div></div>
<div class="control-group email optional">
<label class="email optional control-label" for="url">网址</label>
<div class="controls">
<input class="string email optional" id="url" name="url" size="50" type="email" value="<?php echo $link['url']?>" /></div></div>
