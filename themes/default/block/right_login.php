...
<?php } else{?>
<a href="<?php echo site_url('notifications');?>">暂无新提醒</a>
<?php }?>
</div>
</div>
<?php } else {?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo site_url('user/reg');?>" class="btn btn-default">现在注册</a>(一次注册，永久自动登录)
        <br>
        注册用户<a href="<?php echo site_url('user/login');?>" class="startbbs">点此登入</a>
    </div>
</div>
<?php }?>