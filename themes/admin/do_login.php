...
<div id="wrap"><div class="container-fluid" id="page-main">
<div class="row">
<div class='col-md-6' style="margin: 0 auto;float:none">


<div class='box'>
<div class='cell'><a href="<?php echo site_url()?>" class="startbbs"><?php echo $settings['site_name']?></a> <span class="chevron">&nbsp;›&nbsp;</span> 后台登入</div>
<div class='inner'>
