...
CREATE TABLE IF NOT EXISTS `stb_system` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统配置' AUTO_INCREMENT=62 ;
...
(53, 1, 'mail', 'smtp服务器名称', 'smtp_host', 'smtp.126.com', 1, '', '', 'smtp服务器名称', 0, 1, 0, 0),
(54, 1, 'mail', '服务器端口', 'smtp_port', '25', 1, '', '', '邮箱服务器端口', 0, 1, 1455690641, 1455690641),
(55, 1, 'mail', '邮件发送用户名', 'smtp_user', '', 1, '', '', '邮件发送用户名', 0, 1, 1455690771, 1455690771),
(56, 1, 'mail', '邮箱密码', 'smtp_pswd', '', 1, '', '', '邮箱密码，如果是qq邮箱，则填安全密码', 0, 1, 1455690802, 1455690802),
(57, 1, 'mail', '发件人姓名', 'smtp_sender', 'startbbs', 1, '', '', '发件人姓名', 0, 1, 1455690838, 1455690838),
(58, 1, 'mail', '是否HTML格式邮件', 'smtp_ishtml', '1', 5, '0:否,1:是', '', '是否HTML格式邮件', 0, 0, 1455690888, 1455690888),
(59, 1, 'mail', '是否启用smtp', 'smtp_is', '0', 4, '0:否,1:是', '', '是否启用smtp', 0, 0, 1455690888, 1455690888),
(60, 1, 'user', '是否允许用户注册', 'allow_reg', '1', 5, '0:关闭注册\r\n1:开启注册', '', '是否开放用户注册', 0, 1, 1525325657, 1525325657),
(61, 1, 'user', '禁止注册的用户名', 'user_banned', '', 2, '', '', '一行一个', 0, 1, 1525244421, 1525244421);
